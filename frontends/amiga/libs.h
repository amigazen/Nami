...
/*
 * Always declare class pointers. Proto headers define PROTO_*_H before
 * libs.h is included, which would otherwise hide these externs.
 */
...
extern Class *TabsClass;
extern Class *TextEditorClass;
extern Class *VirtualClass;
...
#define ListViewObj			NewObject(ListViewClass, "gadgets/listview.gadget"
#ifdef __amigaos4__
...
#define RequesterObj		NewObject(RequesterClass, "requester.class"
...
#define TabsObj				NewObject(TabsClass, "gadgets/tabs.gadget"
#define TextEditorObj		NewObject(TextEditorClass, "gadgets/texteditor.gadget"
#define VirtualObj			NewObject(VirtualClass, "gadgets/virtual.gadget"
